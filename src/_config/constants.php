...
define('PATH_PREFIX', $DIR_CONST . '/../');
define('RELATED_JOBS_PER_PAGE', 5);
define('LATEST_JOBS', 5);
...
define('REMOTE_PORTAL', 'deactivated');
define('PASSRECOVERY_LIMIT', '50');
define('ENABLE_SINGLE_ACCOUNT_REGISTRATION', 'disabled');
